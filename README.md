...
Sounds: 
The song and the confirmation voice are synthesized in `PlayMode.cpp` at start-up, no audio files. 
The score data in `chart.hpp` is generated by `build.py` from the Humdrum kern encoding of the fugue in the [humdrum-tools/bach-wtc](https://github.com/humdrum-tools/bach-wtc) repository.
My code automatically scans for the do-si-do and scale patterns.

Download: ready-to-run builds for Windows, Linux and macOS are on the [Releases](https://github.com/dx2102/game3/releases) page.
